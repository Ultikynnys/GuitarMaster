...
describe("song catalog", () => {
  ...
  test("contains exactly 32 valid, uniquely ordered songs", async () => {
    ...
    expect(catalog.map((level) => [level.id, level.categories.flatMap((category) => category.progressions).map((song) => song.id)])).toEqual([
      ...
      ["rhythm-player", ["about-a-girl", "seven-nation-army", "sunshine-of-your-love", "iron-man", "come-as-you-are-intro-verse", "tetris-theme", "lost-woods"]],
      ...
      ["rock-star", ["thunderstruck", "dont-fear-reaper", "sweet-child-o-mine", "gerudo-valley", "halo-theme", "at-dooms-gate"]],
    ]);
    ...
    const expectedBars = {
      ...
      "come-as-you-are-intro-verse": 34,
    };
